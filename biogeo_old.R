...
#######################################################
# This is the example Newick file for Hawaiian Ratsnakes
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
trfn = "/Users/Xin/Documents/Ratsnake_project/manuscript/plylo+div/tree_oldcal2.txt"
...
tr = read.tree(trfn)
#tr = ladderize(tr)
#write.tree(tr, file = "/Users/Xin/Documents/Ratsnake_project/manuscript/plylo+div/tree_oldcal2.txt")
plot(tr)
...
# This is the example geography file for Hawaiian Ratsnakes
# (from Ree & Smith 2008)
geogfn ="ratgeo.txt"
...
numstates_from_numareas(numareas=5, maxareas=4, include_null_range=TRUE)
numstates_from_numareas(numareas=5, maxareas=4, include_null_range=FALSE)
numstates_from_numareas(numareas=5, maxareas=3, include_null_range=TRUE)
numstates_from_numareas(numareas=5, maxareas=2, include_null_range=TRUE)
...
runslow = TRUE
resfn = "Ratsnakes_DEC_M0_ununconstrained_v1.Rdata"
if (runslow)
{
...
resfn = "Ratsnakes_DEC+J_M0_ununconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
...
# PDF plots
#######################################################
pdffn = "Ratsnakes_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
...
#######################################################
par(mar=c(3.5, 0, 2, 0))
analysis_titletxt ="BioGeoBEARS DEC on Ratsnakes M0_unconstrained"
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.8, tipcex=0.5, statecex=0.5, splitcex=0.5, titlecex=0.6, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.8, tipcex=0.5, statecex=0.5, splitcex=0.5, titlecex=0.6, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges, plotlegend=TRUE)

#######################################################
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Ratsnakes M0_unconstrained"
...
# States
res1 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.8, tipcex=0.5, statecex=0.5, splitcex=0.5, titlecex=0.7, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.8, tipcex=0.5, statecex=0.5, splitcex=0.5, titlecex=0.7, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges, plotlegend=TRUE)
...
runslow = TRUE
resfn = "Ratsnakes_DIVALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Ratsnakes_DIVALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Ratsnakes_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=10, height=10)
...
#######################################################
par(mar=c(3.5, 0, 2, 0))
analysis_titletxt ="BioGeoBEARS DIVALIKE on Ratsnakes M0_unconstrained"
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.8, tipcex=0.5, statecex=0.5, splitcex=0.5, titlecex=0.7, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Ratsnakes M0_unconstrained"
...
runslow = TRUE
resfn = "Ratsnakes_BAYAREALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Ratsnakes_BAYAREALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
...
pdffn = "Ratsnakes_BAYAREALIKE_vs_BAYAREALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=10, height=10)
...
#######################################################
par(mar=c(3.5, 0, 2, 0))
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Ratsnakes M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Ratsnakes M0_unconstrained"
...
# Loads to "restable"
save(restable, file="/Users/Xin/Documents/Ratsnake_project/manuscript/plylo+div/Rat_restable_v1.Rdata")
load(file="/Users/Xin/Documents/Ratsnake_project/manuscript/plylo+div/Rat_restable_v1.Rdata")

# Loads to "teststable"
save(teststable, file="/Users/Xin/Documents/Ratsnake_project/manuscript/plylo+div/Rat_teststable_v1.Rdata")
load(file="/Users/Xin/Documents/Ratsnake_project/manuscript/plylo+div/Rat_teststable_v1.Rdata")

# Also save to text files
write.table(restable, file="/Users/Xin/Documents/Ratsnake_project/manuscript/plylo+div/Rat_restable_v1.txt", quote=FALSE, sep="\t")
write.table(unlist_df(teststable), file="/Users/Xin/Documents/Ratsnake_project/manuscript/plylo+div/Rat_teststable_v1.txt", quote=FALSE, sep="\t")
